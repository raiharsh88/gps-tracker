int led = 13; unsigned int Counter = 10;

unsigned long datalength, CheckSum, RLength;

unsigned short topiclength; unsigned char topic[30];

char str[250];

unsigned char encodedByte;

int X; unsigned short MQTTProtocolNameLength;
...
const char MQTTHost[30] = "farmer.cloudmqtt.com";

const char MQTTPort[10] = "1883"; 

const char MQTTClientID[20] = "AB8789"; 

const char MQTTTopic[35] = "GSM_test"; 
...
const char MQTTUsername[30] = "vzykxtyc";

const char MQTTPassword[35] = "KtLns1-gf2wH"; 
...
{ 
  ...
  X = datalength + 2; 
  do
  { encodedByte = X % 128; X = X / 128; if ( X > 0 ) {
      encodedByte |= 128;
    }
    Serial.write(encodedByte);
  }
...
delay(9000);
Serial.print("AT+CIPSTART=\"TCP\",\"farmer.cloudmqtt.com\",\"1883\"\r\n");
delay(6000);
SendConnectPacket();
delay(5000);
